...
export default function Settings() {
    ...
    return (
        <div className="w-full flex flex-col gap-3" style={{ width: "100%" }}>
                ...
                <div className="flex flex-col gap-3 border-2 border-slate-200 p-3 rounded rounded-xl">
                    <div>
                        ...
                        <input
                            type="text"
                            className={
                                "input input-bordered w-full max-w-xs !outline-none outline-0 !border-1 !border-slate-300 "
                            }
                            disabled
                            value={app.name}
                        />
                    ...
                    <div>
                        ...
                        {app.origins.length == 0 ? (
                            <p>There is no origin specified on your app</p>
                        ) : (
            ...
            <section className="flex flex-col gap-1">
                <h3 className="text-xl ml-1">Keys</h3>
                <div className="flex flex-col gap-3 border-2 border-slate-200 p-3 rounded rounded-xl">
                    <p>
                        Here is the secret key you must specify to the SDK in
                        order to send logs to your app.
                    </p>
